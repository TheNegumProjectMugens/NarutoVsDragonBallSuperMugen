...
type = ChangeState
value = 8917
triggerall = command ="Multiple Fire"
trigger1 = (statetype = s) && ctrl
trigger2 = stateno = 200
trigger2 = time > 108
...
[State -1, chute fantasma]
type = ChangeState
value =8863
triggerall = command = "contratake"
trigger2 = stateno = 220
trigger2 = time > 18
trigger1=gametime>1000
...
;BigBang
[State -1,Expanding Attack]
type = ChangeState
value = 5999
triggerall = command = "Expanding Attack"
trigger1 = (statetype = s) && ctrl
trigger2 = stateno = 200
trigger2 = time > 18
triggerall=power>1500
...
;Barrera de ki
[State -1, Expanding Wave]
type = ChangeState
value = 2999
triggerall = command = "Expanding Wave"
trigger1 = (statetype = s) && ctrl
trigger2 = stateno = 200
trigger2 = time > 18
triggerall=power>1500
