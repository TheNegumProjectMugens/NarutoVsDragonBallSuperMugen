...
[Command]
name = "baby Super atack de bolas"
command = b+c
time = 30
...
type = ChangeState
value = 9999
triggerall = command = "baby Super atack de bolas" && Power >= 1500
trigger1 = (statetype = S || statetype = A) && ctrl
trigger2 = Stateno = 107

[State -1, Maliginkienzan]
type = ChangeState
value = 3002
triggerall = command = "Maliginkienzan"
...
type = ChangeState
value = 9292
triggerall = (command = "HyperC1") && power >= 1000
trigger1 = statetype = S && ctrl
...
;---------------------------------------------------------------------------
;joga pra cima
[State -1, Hyper Combo2]
type = ChangeState
value = 9393
triggerall = (command = "HyperC2") && power >= 1000
trigger1 = statetype = S && ctrl
trigger2 = (stateno=[200,249]) && movecontact
trigger3 = (stateno=[400,449]) && movecontact
trigger4 = (stateno = 300) && (movecontact)
...
value = 1449
triggerall = var(6) = 0
triggerall = command = "sequencia-teste"
triggerall = command != "holddown"
trigger1 = statetype = S
trigger1 = ctrl = 1
trigger2 = stateno = 1500
