...
trigger3 = stateno = 220 && time >= 22
trigger4 = time >= 50 && (stateno = 230)
trigger5 = movehit && time >= 25 && stateno = 320
trigger6 = time >= 20 && (stateno = 330)
trigger7 = movehit && time >= 10 && stateno = 420
trigger8 = time >= 25 && (stateno = 430)
trigger9 = time >= 60 && (stateno = 1400)
trigger10 = time >= 180 && (stateno = 1100)
trigger11 = ((time >= 80 && stateno = 1300)||(time >= 130 && stateno = 1180))
trigger12 = time >= 110 && (stateno = 1000)
trigger13 = time >= 65 && (stateno = 1301)
trigger14 = time >= 75 && (stateno = 1500)
;---------------------------------------------------------------------------
; 7
[State -1, 7]
type = ChangeState
...
triggerall = var(2) = 1
value = 2700
;triggerall = command = "Sennen Goroshi"
trigger1 = statetype = S
trigger1 = ctrl
;-------------------------------------------------------------------------------
; Activar IA
