...
;-| Default Values |-------------------------------------------------------
[command]
name = "Senpo Inton Raiha"
command = D,a
time = 15

[command]
name = "Fuuton Disaster"
command = D,b
time = 15

[command]
name = "Final TruthSeeker"
command = D,c
time = 40

[command]
name = "Magma Dimension"
command = D,x
time = 15
...
value = 3000
triggerall = command = "Senpo Inton Raiha"
trigger1 = ctrl
;---------------------------------------------------------------------------
; Fuuton Disaster
...
value = 3100
triggerall = command = "Fuuton Disaster"
trigger1 = ctrl
;---------------------------------------------------------------------------
; Final TruthSeeker
...
value = 3200
triggerall = command = "Final TruthSeeker"
trigger1 = statetype != A
trigger1 = ctrl
;---------------------------------------------------------------------------
; Magma Dimension
...
Triggerall = power >= 2000
value = 1300
triggerall = command = "Magma Dimension"
trigger1 = ctrl
;---------------------------------------------------------------------------
; Magma Dimension Fin
...
Triggerall = power >= 2000
value = 1400
triggerall = command = "Ice Dimension"
trigger1 = ctrl
;---------------------------------------------------------------------------
; Ice Dimension Fin
...
Triggerall = power >= 2000
value = 1500
triggerall = command = "Sand Dimension"
trigger1 = ctrl
;---------------------------------------------------------------------------
; Sand Dimension Fin
[State -1, Ice Dimension Fin]
