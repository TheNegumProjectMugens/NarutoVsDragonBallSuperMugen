...
trigger13 = time > 30 && numhelper(3250) = 0 && stateno = 3200
;---------------------------------------------------------------------------
; Katon Ryuen Hoka no Jutsu Aire
...
trigger1 = ctrl
trigger2 = movecontact && (stateno = 600||stateno = 610)
trigger3 = helper(625),movecontact >= 1 && stateno = 620 && time >= 21
trigger4 = time >= 60 && (stateno = 1480)
trigger5 = time >= 130 && (stateno = 1120)
trigger6 = time >= 110 && (stateno = 1080)
;---------------------------------------------------------------------------
; Suiton Mizu no Maki
