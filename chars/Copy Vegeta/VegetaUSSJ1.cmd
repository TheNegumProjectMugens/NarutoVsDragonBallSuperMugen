...
[Command]
name = "AI_13"
command = ~D, DB, B, B, DB, D, DF, F, a+x
time = 1
[Command]
name = "AI_14"
command = ~D, DB, B, B, DB, D, DF, F, b+y
time = 1
[Command]
name = "AI_15"
command = ~D, DB, B, B, DB, D, DF, F, c+z
time = 1
[Command]
name = "AI_16"
...
[Command]
name = "AI_17"
command = z,y,x,c,b,a,z,y,x,c,b,a,z,y,x,c,b,a
time = 1
[Command]
name = "AI_18"
command = a+x,b+y,c+z,a+x,b+y,c+z,a+x,b+y,c+z,a+x,b+y,c+z
time = 1
[Command]
name = "AI_19"
command = a+b,c+x,x+y,a+b,c+x,x+y,a+b,c+x,x+y,a+b,c+x,x+y,a+b
time = 1
[Command]
name = "AI_20"
command = a+b+c,x+y+z,a+b+c,x+y+z,a+b+c,x+y+z,a+b+c,x+y+z,a+b+c,x+y+z
time = 1
[Command]
name = "AI_21"
command = B,DB,D,DF,F,UF,U,UB,B,a+b
time = 1
[Command]
name = "AI_22"
command = B,DB,D,DF,F,UF,U,UB,B,x+y
time = 1
[Command]
name = "AI_23"
command = B,DB,D,DF,F,UF,U,UB,B,c+z
time = 1
[Command]
name = "AI_24"
command = D,D,D,D,U,U,U,U,B,B,B,B,F,F,F,F,a+b+c
time = 1
[Command]
name = "AI_25"
command = D,D,D,D,U,U,U,U,B,B,B,B,F,F,F,F,x+y+z
time = 1
;=================[Level 4]=====================================================
[command]
...
[State -1, 10]
type = ChangeState
triggerall = RoundState = 2 && var(59)!=0 && (PREVSTATENO != [10,12])
...
[State -1, 105/40]
type = ChangeState
triggerall = RoundState = 2 && var(59)!=0 && BACKEDGEBODYDIST >120
trigger1 = p2bodydist x < 60 && (random=[0,200])
trigger1 = Ctrl && statetype = S
value = 105
[State -1, 130]
type = ChangeState
triggerall = RoundState = 2 && var(59)!=0 && var(56)!=1
...
[State -1, Charge]
type = ChangeState
triggerall = power < 3000 && var(59) = 1 && p2bodydist x > 100 && var(56)=0
trigger1 = statetype = S && ctrl && random < 300 && p2bodydist x > 100 && var(56)=0
value = 730
[State -1, Zero-Counter]
type = ChangeState
triggerall = RoundState = 2 && var(59)!=0 && (stateno = [150,155]) && power >=500
trigger1 = p2bodydist x < 30 && random < 250
value = IFELSE(statetype = A,744,740)
[State -1, Zanzoken]
type = ChangeState
triggerall = RoundState = 2 && var(59)!=0 && var(56)!=1 && power >=250&& p2statetype != L
...
[State -1, Taunt]
type = ChangeState
triggerall = var(59) = 1 && (p2bodydist x > 100 && p2statetype = L)
trigger1 = statetype = S && ctrl && random < 100
value = 195
[State -1, Agarre]
type = ChangeState
triggerall = RoundState = 2 && var(59)!=0 && p2statetype != L; && p2statetype != L
...
[State -1, 2000]
type = ChangeState
triggerall = RoundState = 2 && var(59)!=0 && p2statetype != L && power >= 150
...
[State -1, 1301]
type = ChangeState
triggerall = RoundState = 2 && var(59)!=0 && p2statetype != L && power >=500
...
[State -1, 2100]
type = ChangeState
triggerall = RoundState = 2 && var(59)!=0 && power >= 100
...
[State -1, 2102]
type = ChangeState
triggerall = RoundState = 2 && var(59)!=0 && p2statetype != L && numhelper(2110)>0
trigger1 = p2bodydist y > 60 && (random=[0,500])
trigger1 = (Ctrl) && statetype !=A
value = 2102
[State -1, 2200]
type = ChangeState
triggerall = RoundState = 2 && var(59)!=0 && p2statetype != L && power >= 400
...
[State -1, 3100]
type = ChangeState
triggerall = RoundState = 2 && var(59)!=0 && p2statetype != L && power >= 1000
...
[State -1, 3200]
type = ChangeState
triggerall = RoundState = 2 && var(59)!=0 && p2statetype != L && power >= 2000
...
[State -1, 3600]
type = ChangeState
triggerall = RoundState = 2 && var(59)!=0 && p2statetype != L && power >= 3000
